# Generated by Django 4.2.4 on 2023-12-01 19:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sku', models.BigIntegerField(blank=True, null=True, unique=True, verbose_name='Código de barras')),
                ('expire_at', models.DateField(blank=True, default=None, help_text='(Opcional) Indicar fecha de expiración si corresponde', null=True, verbose_name='Fecha de Vencimiento')),
                ...
                ('maintenance_hour', models.IntegerField(blank=True, default=None, help_text='(Opcional) Indicar cada cuántas horas de uso se debe hacer mantenimiento', null=True, verbose_name='Horas de uso para mantenimiento')),
                ('usage_hours', models.IntegerField(blank=True, default=None, help_text='(Opcional) Horas de uso reseteables', null=True, verbose_name='Horas de uso')),
                ('total_usage_hours', models.IntegerField(blank=True, default=None, help_text='(Opcional) Horas de uso totales. Por defecto es cero', null=True, verbose_name='Horas de uso totales')),
                ('last_maintenance', models.DateField(blank=True, default=None, null=True, verbose_name='Última mantención')),
                ('create_date', models.DateTimeField(default=django.utils.timezone.now, editable=False, verbose_name='Fecha de creación')),
                ...
                ('compartments', models.ForeignKey(help_text='Seleccionar en qué gabeta está ubicado', on_delete=django.db.models.deletion.CASCADE, to='Website.compartment', verbose_name='Gabeta/compartimento')),
                ('container', models.ForeignKey(blank=True, default=None, help_text='(Opcional) Si el insumo está contenido dentro de otro insumo, indicarlo aquí', null=True, on_delete=django.db.models.deletion.CASCADE, to='Website.inventory', verbose_name='Insumo contenedor')),
            ],
            options={
                'verbose_name': 'Insumo',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, default=None, help_text='(Opcional) Indicar programa de mantención si corresponde', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Website.maintenanceprogram', verbose_name='Programa de mantenimiento'),
        ),
        migrations.AddField(
            model_name='inventory',
            name='status',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.CharField(blank=True, help_text='(Opcional) Ingrese el año de fabricación del vehículo', max_length=4, null=True, verbose_name='Año')),
                ('image', models.ImageField(blank=True, default='default-firetruck.png', help_text='(Opcional) Subir imagen del vehículo', null=True, upload_to='firetrucks', verbose_name='Imagen')),
                ...
                ('type_fire_trucks', models.ForeignKey(help_text='Seleccionar tipo de vehículo', on_delete=django.db.models.deletion.DO_NOTHING, to='Website.typefiretruck', verbose_name='Tipo de vehículo')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='fire_trucks',
            field=models.ForeignKey(help_text='Seleccionar vehículo bomberil correspondiente', on_delete=django.db.models.deletion.CASCADE, to='Website.firetruck', verbose_name='Vehículo'),
        ),
    ]
